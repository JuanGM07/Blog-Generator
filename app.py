...
with col1:
    st.markdown("Hello, I am Juan Gonzalez, engineer student and data scientist.")
    st.markdown("For any request my e-mail is: juanglezm3@gmail.com.")
...
def update_text_with_example():
    st.session_state.idea_input = "What is the meaning of life"
